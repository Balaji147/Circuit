...
SELECT * from circuit_users_info where ct_company_id = 13
...
delete from circuit_users_auth where circuit_users_auth_id = 97

select * from circuit_users_info

delete from circuit_users_info
